...
import baon.logic.ast.rules.RuleSet

from baon.logic.parsing.RulesParser import RulesParser
from baon.logic.rules.SemanticCheckScope import SemanticCheckScope
...
class RuleSet(object):
    ...
    def __init__(self, rule_set_node=None):
        if rule_set_node is None:
            rule_set_node = baon.logic.ast.rules.RuleSet.RuleSet()
