...
import lib.action_functions
import lib.simple_text_functions
...
FUNC_DICT = scan_package_for_functions(lib.action_functions)
SIMPLE_FUNC_DICT = scan_package_for_functions(lib.simple_text_functions)
